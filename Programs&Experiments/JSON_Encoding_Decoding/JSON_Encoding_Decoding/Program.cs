...
namespace JSON_Encoding_Decoding
{
	class Program
	{
	...
	public class JSON
	{
		...
		public static string JsonEncode(object json)
		{
			...
			bool success = new JSON().SerializeValue(json, builder);
		...
		protected object ParseValue(char[] json, ref int index, ref bool success)
		{
			...
			//logger.Error("Parse error: ", new Exception(lastDecode.Substring(index - 10)));
		...
		protected bool IsNumeric(object o)
		{
			try
			{
				Double.Parse(o.ToString(), CultureInfo.InvariantCulture);
			}
			catch (Exception)
			{
				return false;
